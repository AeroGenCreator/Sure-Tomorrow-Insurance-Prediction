...
🚀 Interactive Demo
Experience the model in action and explore data correlations in real-time through the web interface: 

👉 [Link to Web App](https://sure-tomorrow-insurance-prediction.onrender.com), also [PDF Notebook](https://www.notion.so/Algunos-de-Mis-Notebooks-2dc8851a844d80ba86bce36d9cd2c35e)
